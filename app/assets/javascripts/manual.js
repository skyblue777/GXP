$(document).ready(function(){
  ...
  $(".book_audio").bind('contextmenu',function() { return false; });
  $(".about_video").bind('contextmenu',function() { return false; });
  $(".modal-body").bind('contextmenu',function() { return false; });
  $(".project_video").bind('contextmenu', function(){return false;});
  $(".project_audio").bind('contextmenu', function(){return false;});
